...
const PeriodosJefeLab = () => {
    ...
    const renderGestionLaboratorios=(rowData)=>{
        return (
            ...
            <Button icon= "pi pi-chevron-circle-right" className="p-button-rounded p-button-info" onClick={() => {
                ...
                navigate('/plataforma/laboratoriosjefe/'+rowData.id_Periodo);
            }}/>
            </div>
    ...
    const cambiarBreadLocal = (lblActual, rowData) => {
        ...
        direccionesTemp.push({ label: actual, url: '/plataforma/gestionjefelaboratorio' });
  ...
  return (
    <div>
       ...
       <center><h2>Periodos de Gestion Jefe de Laboratorio</h2></center> 
        <DataTable value={periodos} scrollable scrollHeight="480px"  responsiveLayout="scroll" >
            ...
            <Column body={renderGestionLaboratorios} header='Gestión Laboratorios'></Column>
        </DataTable>
    </div>
...
export default PeriodosJefeLab